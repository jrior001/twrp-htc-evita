...
TARGET_INIT_VENDOR_LIB := libinit_evita
TARGET_LIBINIT_DEFINES_FILE := device/htc/evita/init/init_evita.c
...
TARGET_RECOVERY_DEVICE_MODULES := chargeled libinit_evita
